...
const HeroSection = () => {
  return (
    <section className="sm:mt-22 pb-52 relative" id="Home">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="dark:text-white text-balck mb-4 text-3xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
          ...
          <p className="dark:text-[#ADB7BE] text-black text-base sm:text-lg mb-6 lg:text-xl">
            ...
            ReactJS,NextJs,React Native , I Have +4 Years Experience and Iam
